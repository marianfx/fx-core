...
namespace FX.Core.Automation.Abstract
{
        ...
        where P : ScraperParameters
    {
        ...
        /// <returns></returns>
        Task WaitForElement(string elementSelector, int timeout = 600000);
        ...
        /// <returns></returns>
        Task ScrollTo(string selector, int toHeight, bool aproximate = true, bool useWindow = false);

        /// <summary>
        /// Closes the annoying elements as defined in the settings
        /// </summary>
        /// <returns></returns>
        Task CloseAnnoyingElements();
